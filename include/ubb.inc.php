...
?>
				...
				<div id="font">
					...
					<strong onclick="font(20)">18px</strong>
					<strong onclick="font(22)">18px</strong>
					<strong onclick="font(24)">18px</strong>
				...
				<div id="color">
					...
					<strong title="绿色" style="background:#07792e" onclick="showcolor('#07792e')"></strong>
