...
$result=_query("SELECT t_id,t_status,t_fromuser,t_time,t_content
									FROM t_message
										WHERE t_touser='{$_COOKIE['username']}'
					...
					<table cellspacing="1">
						...
						$html=array();
								while (!!$rows=_fetch_array_list($result)){
									...
									$html['t_fromuser']=$rows['t_fromuser'];
								...
								?>
								<tr><td><?php echo $html['t_fromuser']?></td>
