...
session_start();
define('IN_TG',true);
define('SCRIPT','business');
require dirname(__FILE__).'/include/common.inc.php';
//检查是否正常登陆
if(isset($_COOKIE['username'])){
	$rows=_fetch_array("SELECT t_login_count,t_last_ip,t_last_time,t_username,t_sex,t_face,t_email,t_level,t_reg_time,t_phone
											FROM t_user WHERE t_username='{$_COOKIE['username']}'");
	if($rows){
		$html=array();
