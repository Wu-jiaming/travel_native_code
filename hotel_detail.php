...
if (isset($_GET['id']))
		{
			$mark=0;
			if(!!($rows=_fetch_array("select * from t_hotel where t_id='{$_GET['id']}'")))
			{
				$html = array();
...
<div id="scence">
	<h2>景点详细</h2><h3><?php echo $html['name']?></h3>
		...
		<p><?php echo $html['scence_content']?></p><p><?php echo $html['price']?></p>
			...
			<div id="pingfen">
				<span><?php $count = _query("select count(*) from t_pay where t_pay_status ='1'")?><?php echo $garde['total_grade']?></span>/5(<?php echo $count?>人出游)
			...
			<div id ="select">
				<form method="post" action="order.php?action=order&id=<?php echo $_GET['id']?>">
					<dl><?php echo $clean['scence_id']?>
						<dd>入住时间 <select name="year"><option value="2017" selected="selected">2017</option><option value="2018">2018</option><option value="2019">2019</option><option value="2020">2020</option>
														</select>
										...
										离开时间 <select name="year"><option value="2017" selected="selected">2017</option><option value="2018">2018</option><option value="2019">2019</option><option value="2020">2020</option>
														</select>
													年<select name="month"><option value="01" selected="selected">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option>
																									<option value="05" >05</option><option value="2018">06</option><option value="2019">07</option><option value="08">08</option>
																									<option value="09" >09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option>
			...
			<div id="mokuai">
				<a href="hotel_detail?id=<?php echo $html['scence_id']?>&detail=jiudian">周边酒店</a>
				<a href="hotel_detail?id=<?php echo $html['scence_id']?>&detail=jingdian">周边景点</a>
				<a href="hotel_detail?id=<?php echo $html['scence_id']?>&detail=tuangou">周边商场</a>
				<a href="hotel_detail?id=<?php echo $html['scence_id']?>&detail=jiaotong">附近交通</a>
				<a href="hotel_detail?id=<?php echo $html['scence_id']?>&detail=comment">查看评论</a>
			</div>
