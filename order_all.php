...
_query("select t_id from t_user where t_username = '{$_COOKIE['username']}'");
global  $pagesize,$pagenum;
_page("SELECT t_id FROM t_pay WHERE t_business_id=1 ",15);
...
?>
				<div id="member_main">
					...
					<table cellspacing="1">
						<tr><th>套餐id</th><th>价格</th><th>人数</th><th>套餐内容</th><th>下单时间</th><th>下单会员</th><th>支付</th><th>浏览</th><th>操作</th></tr>
						...
						<tr>
								...
								<td><?php echo $html['pay_status']?></td>
